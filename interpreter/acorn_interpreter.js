...
var mod$$inline_58 = function (a) {
  ...
  function d(a) {
    a = a.split(" ");
    for (var c = Object.create(null), b = 0; b < a.length; b++) c[a[b]] = !0;
    return function (d) {
      return c[d] || !1;
    };
  }
...
function r(a, b) {
  ...
  for (g in this)
    "function" === typeof this[g] &&
      (e = g.match(a)) &&
      (this.lb[e[1]] = this[g].bind(this));
  this.R = Ha(this, this.ka, null);
  this.Sa = this.R.object;
  this.ka = Ga(this.$.join("\n"), "polyfills");
  this.$ = void 0;
  Ia(this.ka, void 0, void 0);
  e = new t(this.ka, this.R);
  e.done = !1;
  this.o = [e];
  this.xb();
  this.value = void 0;
...
p.Bb = function (a) {
  ...
  "string" === typeof a && (a = Ga(a, "appendCode" + this.Cb++));
  if (!a || "Program" !== a.type)
...
p.fb = function () {
  ...
  do {
    ...
    var c = d.node,
      e = c.type;
    if ("Program" === e && d.done) return !1;
    if (this.sa) break;
    try {
      var g = this.lb[e](a, d, c);
    } catch (l) {
      if (l !== Na) throw l;
    }
    g && a.push(g);
...
function Kb(a, b) {
  ...
  d.eval = !0;
  a.g(b, "eval", d, u);
  a.g(b, "parseInt", a.i(parseInt, !1), u);
  a.g(b, "parseFloat", a.i(parseFloat, !1), u);
  a.g(b, "isNaN", a.i(isNaN, !1), u);
  a.g(b, "isFinite", a.i(isFinite, !1), u);
  d = [
    [escape, "escape"],
    [unescape, "unescape"],
    [decodeURI, "decodeURI"],
...
function Lb(a, b) {
  ...
  var c = function (e) {
    ...
    if (l) {
      ...
      for (var v = 0; v < l.length; v++) {
        var E = l[v];
        d.test(E) || J(a, a.ja, "Invalid function argument: " + E);
      }
      l = l.join(", ");
    }
    try {
      var M = Ga("(function(" + l + ") {" + g + "})", "function" + a.Pb++);
    } catch (D) {
      J(a, a.ja, "Invalid code: " + D.message);
    }
    1 !== M.body.length && J(a, a.ja, "Invalid code in function body.");
    return Dc(a, M.body[0].expression, a.R, "anonymous");
  };
  a.M = a.i(c, !0);
  a.g(b, "Function", a.M, u);
  a.g(a.M, "prototype", a.X, u);
  a.g(a.X, "constructor", a.M, u);
  a.X.La = function () {};
  a.X.La.id = a.Ra++;
  a.X.ub = !0;
  a.g(a.X, "length", 0, B);
  ...
  c = function (e, g) {
    ...
    null !== g &&
      ...
      (g instanceof C
        ? (l.G = Ec(a, g))
        : J(a, a.m, "CreateListFromArrayLike called on non-object"));
    l.Ya = !1;
  };
  L(a, a.M, "apply", c);
  c = function (e) {
  ...
  L(a, a.M, "toString", c);
  a.g(a.M, "toString", a.i(c, !1), u);
  c = function () {
    return this.valueOf();
  };
  L(a, a.M, "valueOf", c);
  a.g(a.M, "valueOf", a.i(c, !1), u);
}
function Mb(a, b) {
  function d(e) {
    (void 0 !== e && null !== e) ||
      J(a, a.m, "Cannot convert '" + e + "' to object");
  }
  var c = function (e) {
    if (void 0 === e || null === e) return Fc(a) ? this : a.s(a.L);
    if (!(e instanceof C)) {
      var g = a.s(Gc(a, e));
      g.data = e;
      return g;
  ...
  a.v = a.i(c, !0);
  a.g(a.v, "prototype", a.L, u);
  a.g(a.L, "constructor", a.v, u);
  a.g(b, "Object", a.v, u);
  c = function (e) {
    d(e);
    return Hc(a, Object.getOwnPropertyNames(e instanceof C ? e.h : e));
  };
  a.g(a.v, "getOwnPropertyNames", a.i(c, !1), u);
  c = function (e) {
    d(e);
    e instanceof C && (e = e.h);
    return Hc(a, Object.keys(e));
  };
  a.g(a.v, "keys", a.i(c, !1), u);
  c = function (e) {
    if (null === e) return a.s(null);
    e instanceof C ||
      J(a, a.m, "Object prototype may only be an Object or null");
    return a.s(e);
  };
  a.g(a.v, "create", a.i(c, !1), u);
  a.$.push(
    "(function() {",
  ...
  c = function (e, g, l) {
    g = String(g);
    e instanceof C || J(a, a.m, "Object.defineProperty called on non-object");
    l instanceof C || J(a, a.m, "Property description must be an object");
    !e.h[g] &&
      e.preventExtensions &&
      J(a, a.m, "Can't define property '" + g + "', object is not extensible");
    a.g(e, g, Pa, l.h);
    return e;
  };
  a.g(a.v, "defineProperty", a.i(c, !1), u);
  a.$.push(
    "(function() {",
  ...
  c = function (e, g) {
    e instanceof C ||
      J(a, a.m, "Object.getOwnPropertyDescriptor called on non-object");
    g = String(g);
    if (g in e.h) {
      var l = Object.getOwnPropertyDescriptor(e.h, g),
        v = e.T[g];
      e = e.W[g];
      g = a.s(a.L);
      v || e
        ? (a.g(g, "get", v), a.g(g, "set", e))
  ...
  a.g(a.v, "getOwnPropertyDescriptor", a.i(c, !1), u);
  c = function (e) {
    d(e);
    return Gc(a, e);
  };
  a.g(a.v, "getPrototypeOf", a.i(c, !1), u);
  c = function (e) {
    return !!e && !e.preventExtensions;
  };
  a.g(a.v, "isExtensible", a.i(c, !1), u);
  c = function (e) {
    e instanceof C && (e.preventExtensions = !0);
    return e;
  };
  a.g(a.v, "preventExtensions", a.i(c, !1), u);
  L(a, a.v, "toString", C.prototype.toString);
  L(a, a.v, "toLocaleString", C.prototype.toString);
  L(a, a.v, "valueOf", C.prototype.valueOf);
  c = function (e) {
    d(this);
    return this instanceof C ? String(e) in this.h : this.hasOwnProperty(e);
  };
  L(a, a.v, "hasOwnProperty", c);
  c = function (e) {
    d(this);
  ...
  L(a, a.v, "propertyIsEnumerable", c);
  c = function (e) {
    for (;;) {
      e = Gc(a, e);
      if (!e) return !1;
  ...
  L(a, a.v, "isPrototypeOf", c);
}
function Nb(a, b) {
  var d = function (c) {
    var e = Fc(a) ? this : Ic(a),
      g = arguments[0];
    if (1 === arguments.length && "number" === typeof g)
      isNaN(Hb(g)) && J(a, a.ib, "Invalid array length"), (e.h.length = g);
    else {
...
function Ob(a, b) {
  ...
  a.J = a.i(d, !0);
  a.g(b, "String", a.J, u);
  a.g(a.J, "fromCharCode", a.i(String.fromCharCode, !1), u);
  b =
  ...
  for (d = 0; d < b.length; d++) L(a, a.J, b[d], String.prototype[b[d]]);
  d = function (c, e, g) {
    e = a.O(e);
    g = a.O(g);
    try {
      ...
      J(a, a.F, "localeCompare: " + l.message);
    }
  };
  L(a, a.J, "localeCompare", d);
  d = function (c, e, g) {
    var l = String(this);
    e = e ? Number(e) : void 0;
  ...
  d = function (c, e) {
    ...
    if (2 === a.REGEXP_MODE)
      if (fb)
        (c = Kc(a, "string.match(regexp)", { string: g, regexp: c }, c, e)),
          c !== Qa && e(c && Hc(a, c));
      else {
        var l = a.da(),
          v = Lc(a, c, l, e);
  ...
  d = function (c, e) {
    ...
    if (2 === a.REGEXP_MODE)
      if (fb)
        (c = Kc(a, "string.search(regexp)", { string: g, regexp: c }, c, e)),
          c !== Qa && e(c);
      else {
        var l = a.da(),
          v = Lc(a, c, l, e);
...
function Rb(a, b) {
  ...
  a.g(b, "Date", a.Y, u);
  a.g(a.Y, "now", a.i(Date.now, !1), u);
  a.g(a.Y, "parse", a.i(Date.parse, !1), u);
  a.g(a.Y, "UTC", a.i(Date.UTC, !1), u);
  b =
  ...
  for (var c = 0; c < b.length; c++)
    (d = (function (e) {
      return function (g) {
        var l = this.data;
        l instanceof Date || J(a, a.m, e + " not called on a Date");
        for (var v = [], E = 0; E < arguments.length; E++)
          v[E] = a.O(arguments[E]);
        return l[e].apply(l, v);
      };
    })(b[c])),
      L(a, a.Y, b[c], d);
}
function Sb(a, b) {
  ...
  d = function (c, e) {
    function g(D) {
      if (D) {
        var ta = Hc(a, D);
        a.g(ta, "index", D.index);
        a.g(ta, "input", D.input);
        return ta;
      }
      return null;
    }
    ...
    if (2 === a.REGEXP_MODE)
      if (fb)
        (c = Kc(a, "regexp.exec(string)", { string: c, regexp: l }, l, e)),
          c !== Qa && (a.g(this, "lastIndex", l.lastIndex), e(g(c)));
      else {
        var v = a.da(),
          E = Lc(a, l, v, e),
          M = this;
        v.onmessage = function (D) {
          clearTimeout(E);
          a.g(M, "lastIndex", D.data[1]);
          e(g(D.data[0]));
        };
        v.postMessage(["exec", l, l.lastIndex, c]);
      }
    else (c = l.exec(c)), a.g(this, "lastIndex", l.lastIndex), e(g(c));
  };
  Mc(a, a.I, "exec", d);
}
function Tb(a, b) {
  function d(c) {
    var e = a.i(function (g) {
      var l = Fc(a) ? this : a.ta(e);
      Oc(a, l, g);
      return l;
    }, !0);
    a.g(e, "prototype", a.ta(a.F), u);
    a.g(e.h.prototype, "name", c, u);
    a.g(b, c, e, u);
    return e;
  }
  a.F = a.i(function (c) {
    var e = Fc(a) ? this : a.ta(a.F);
    Oc(a, e, c);
    return e;
  }, !0);
  a.g(b, "Error", a.F, u);
  a.g(a.F.h.prototype, "message", "", u);
  a.g(a.F.h.prototype, "name", "Error", u);
  d("EvalError");
  a.ib = d("RangeError");
...
function Ub(a, b) {
  ...
  for (b = 0; b < c.length; b++) a.g(d, c[b], a.i(Math[c[b]], !1), u);
}
function Cc(a, b) {
  function d(e) {
    try {
  ...
  d = function (e, g, l) {
    g && "Function" === g.H
      ? J(a, a.m, "Function replacer on JSON.stringify not supported")
      : g && "Array" === g.H
      ? ((g = Ec(a, g)),
...
function Oc(a, b, d) {
  ...
  for (var c = a.o.length - 1; 0 <= c; c--) {
    ...
    "CallExpression" === g.type &&
      (e = e.ba) &&
      d.length &&
      (d[d.length - 1].name = a.D(e, "name"));
    !g.loc || (d.length && "CallExpression" !== g.type) || d.push({ V: g.loc });
  }
  g = String(a.D(b, "name"));
...
function Kc(a, b, d, c, e) {
  ...
  try {
    ...
    e(null), J(a, a.F, "RegExp Timeout: " + c);
  }
  return Qa;
}
function Jc(a, b, d) {
  ...
  c || (d(null), J(a, a.F, "Regular expressions not supported: " + b));
}
function Lc(a, b, d, c) {
...
function ed(a, b, d) {
  var c = a.s(a.X);
  d
    ? ((d = a.s(a.L)), a.g(c, "prototype", d, u), a.g(d, "constructor", c, u))
    : (c.ub = !0);
  a.g(c, "length", b, B);
  c.H = "Function";
  return c;
...
p.Ba = function (a) {
  if (a instanceof C) throw Error("Object is already pseudo");
...
p.O = function (a, b) {
  if (("object" !== typeof a && "function" !== typeof a) || null === a)
    return a;
  if (!(a instanceof C)) throw Error("Object is not pseudo");
  if (P(this, a, this.I))
    return (
  ...
  if (P(this, a, this.ia)) {
    var c = [];
    b.Ka.push(c);
    var e = this.D(a, "length");
    for (d = 0; d < e; d++) fd(this, a, d) && (c[d] = this.O(this.D(a, d), b));
  } else
    for (e in ((c = {}), b.Ka.push(c), a.h))
      (d = this.O(a.h[e], b)),
...
function Hc(a, b) {
  for (
    var d = Ic(a), c = Object.getOwnPropertyNames(b), e = 0;
    e < c.length;
    e++
  )
    a.g(d, c[e], b[c[e]]);
...
p.D = function (a, b) {
  ...
  b = String(b);
  (void 0 !== a && null !== a) ||
    J(this, this.m, "Cannot read property '" + b + "' of " + a);
  if ("object" === typeof a && !(a instanceof C))
  ...
  do if (a.h && b in a.h) return (d = a.T[b]) ? ((this.N = !0), d) : a.h[b];
  while ((a = Gc(this, a)));
};
function fd(a, b, d) {
  if (!(b instanceof C))
...
p.g = function (a, b, d, c) {
  ...
  b = String(b);
  (void 0 !== a && null !== a) ||
    J(this, this.m, "Cannot set property '" + b + "' of " + a);
  if ("object" === typeof a && !(a instanceof C))
    throw TypeError("Expecting native value or pseudo object");
  c &&
    ("get" in c || "set" in c) &&
  ...
  if (a instanceof C) {
    ...
    if ("Array" === a.H)
      if (((g = a.h.length), "length" === b)) {
        ...
        d = Hb(d);
        isNaN(d) && J(this, this.ib, "Invalid array length");
        if (d < g)
          for (l in a.h) {
            var l = Ib(l);
    ...
    if (!a.preventExtensions || b in a.h)
      if (c) {
        e = {};
        "get" in c && c.get && ((a.T[b] = c.get), (e.get = this.g.Vb));
        "set" in c && c.set && ((a.W[b] = c.set), (e.set = this.g.Wb));
        "configurable" in c && (e.configurable = c.configurable);
        "enumerable" in c && (e.enumerable = c.enumerable);
        "writable" in c &&
          ((e.writable = c.writable), delete a.T[b], delete a.W[b]);
        "value" in c
          ? ((e.value = c.value), delete a.T[b], delete a.W[b])
          : d !== Pa && ((e.value = d), delete a.T[b], delete a.W[b]);
        try {
          Object.defineProperty(a.h, b, e);
        } catch (v) {
          J(this, this.m, "Cannot redefine property: " + b);
        }
        ...
        if (c.W && c.W[b]) return (this.Da = !0), c.W[b];
        if (c.T && c.T[b])
          e &&
            J(
              this,
    ...
    e && J(this, this.m, "Can't create property '" + b + "' on '" + a + "'");
};
p.g.Vb = function () {
...
function L(a, b, d, c) {
  a.g(b.h.prototype, d, a.i(c, !1), u);
}
function Mc(a, b, d, c) {
  a.g(b.h.prototype, d, a.ob(c), u);
}
function gd(a) {
...
function jd(a, b) {
  for (var d = gd(a); d && d !== a.R; ) {
    if (b in d.object.h) return d.object.h[b];
    d = d.Oa;
  }
  if (d === a.R && fd(a, d.object, b)) return a.D(d.object, b);
  d = a.o[a.o.length - 1].node;
  ("UnaryExpression" === d.type && "typeof" === d.operator) ||
    J(a, a.jb, b + " is not defined");
}
function kd(a, b, d) {
  for (var c = gd(a), e = c.P; c && c !== a.R; ) {
    if (b in c.object.h) {
      c.object.h[b] = d;
      return;
    }
  ...
  if (c === a.R && (!e || fd(a, c.object, b))) return a.g(c.object, b, d);
  J(a, a.jb, b + " is not defined");
}
function Jb(a, b, d) {
    ...
    if (l && "object" === typeof l)
      if (Array.isArray(l))
        for (c = 0; c < l.length; c++)
          l[c] && l[c].constructor === e && Jb(a, l[c], d);
...
function nd(a, b, d, c) {
  ...
  a: for (; 0 < e.length; e.pop()) {
    ...
    if (1 === b) {
      if (c ? g.labels && -1 !== g.labels.indexOf(c) : g.U || g.Tb) {
        e.pop();
        return;
      }
    } else if (2 === b && (c ? g.labels && -1 !== g.labels.indexOf(c) : g.U))
      return;
  }
  P(a, d, a.F)
    ? ((b = {
...
function od(a, b, d) {
  ...
  a = new t(c, a.o[a.o.length - 1].scope);
  a.na = !0;
  a.B = d;
  a.ba = b;
  a.Xa = !0;
...
function pd(a, b, d, c) {
  ...
  var e = new a.Ga({ options: {} });
  e.type = "CallExpression";
  a = new t(e, a.o[a.o.length - 1].scope);
  a.na = !0;
  a.B = d;
  a.ba = b;
  a.Xa = !0;
...
p.data = null;
p.toString = function () {
  if (!(this instanceof C)) return String(this);
  if ("Array" === this.H) {
    var a = eb;
    a.push(this);
    try {
      ...
      for (var e = 0; e < d; e++) {
        var g = this.h[e];
        b[e] = g instanceof C && -1 !== a.indexOf(g) ? "..." : g;
      }
      c && b.push("...");
    } finally {
      a.pop();
...
r.prototype.stepArrayExpression = function (a, b, d) {
  d = d.elements;
  var c = b.A || 0;
  b.Ha
  ...
  for (; c < d.length; ) {
    if (d[c]) return (b.A = c), new t(d[c], b.scope);
    c++;
  }
  a.pop();
  a[a.length - 1].value = b.Ha;
};
r.prototype.stepAssignmentExpression = function (a, b, d) {
  if (!b.ea) return (b.ea = !0), (b = new t(d.left, b.scope)), (b.ma = !0), b;
  if (!b.wa) {
    b.ya || (b.ya = b.value);
    b.ua && (b.fa = b.value);
    if (
...
r.prototype.stepBinaryExpression = function (a, b, d) {
  if (!b.ea) return (b.ea = !0), new t(d.left, b.scope);
  if (!b.wa) return (b.wa = !0), (b.fa = b.value), new t(d.right, b.scope);
  a.pop();
  var c = b.fa;
  b = b.value;
  switch (d.operator) {
    ...
    case "in":
      b instanceof C ||
        J(this, this.m, "'in' expects an object, not '" + b + "'");
      d = fd(this, b, c);
      break;
    case "instanceof":
      P(this, b, this.M) ||
        J(this, this.m, "Right-hand side of instanceof is not an object");
      d = c instanceof C ? P(this, c, b) : !1;
      break;
    default:
...
r.prototype.stepBlockStatement = function (a, b, d) {
  var c = b.A || 0;
  if ((d = d.body[c])) return (b.A = c + 1), new t(d, b.scope);
  a.pop();
};
r.prototype.stepBreakStatement = function (a, b, d) {
  nd(this, 1, void 0, d.label && d.label.name);
};
r.prototype.Ab = 0;
r.prototype.stepCallExpression = function (a, b, d) {
  if (!b.na) {
    b.na = 1;
    var c = new t(d.callee, b.scope);
    c.ma = !0;
    return c;
  }
  if (1 === b.na) {
  ...
  if (!b.Xa) {
    ...
    if (d.arguments[b.A]) return new t(d.arguments[b.A++], b.scope);
    if ("NewExpression" === d.type) {
      (c instanceof C && !c.ub) || J(this, this.m, c + " is not a constructor");
      if (c === this.ia) b.B = Ic(this);
      else {
        var e = c.h.prototype;
        if ("object" !== typeof e || null === e) e = this.L;
        b.B = this.s(e);
      }
      b.isConstructor = !0;
    }
    ...
    if (c.eval)
      if (((c = b.G[0]), "string" !== typeof c)) b.value = c;
        ...
        try {
          ...
          J(this, this.ja, "Invalid code: " + v.message);
        }
        c = new this.Ga({ options: {} });
        c.type = "EvalProgram_";
        c.body = g.body;
        Ia(c, d.start, d.end);
        d = b.Gb ? b.scope : this.R;
      ...
      c.Ta.apply(b.B, g);
    } else J(this, this.m, c.H + " is not callable");
  }
};
r.prototype.stepCatchClause = function (a, b, d) {
  if (b.S) a.pop();
  else
    return (
      (b.S = !0),
      (a = id(this, b.scope)),
      this.g(a.object, d.param.name, b.cc),
      new t(d.body, a)
    );
};
r.prototype.stepConditionalExpression = function (a, b, d) {
  var c = b.ga || 0;
  if (0 === c) return (b.ga = 1), new t(d.test, b.scope);
  if (1 === c) {
    b.ga = 2;
    if ((c = !!b.value) && d.consequent) return new t(d.consequent, b.scope);
    if (!c && d.alternate) return new t(d.alternate, b.scope);
    this.value = void 0;
  }
  a.pop();
  "ConditionalExpression" === d.type && (a[a.length - 1].value = b.value);
};
r.prototype.stepContinueStatement = function (a, b, d) {
  nd(this, 2, void 0, d.label && d.label.name);
};
r.prototype.stepDebuggerStatement = function (a) {
  a.pop();
};
r.prototype.stepDoWhileStatement = function (a, b, d) {
  "DoWhileStatement" === d.type &&
    void 0 === b.ca &&
    ((b.value = !0), (b.ca = !0));
  if (!b.ca) return (b.ca = !0), new t(d.test, b.scope);
  if (!b.value) a.pop();
  else if (d.body) return (b.ca = !1), (b.U = !0), new t(d.body, b.scope);
};
r.prototype.stepEmptyStatement = function (a) {
  a.pop();
};
r.prototype.stepEvalProgram_ = function (a, b, d) {
  var c = b.A || 0;
  if ((d = d.body[c])) return (b.A = c + 1), new t(d, b.scope);
  a.pop();
  a[a.length - 1].value = this.value;
};
r.prototype.stepExpressionStatement = function (a, b, d) {
  if (!b.S) return (b.S = !0), new t(d.expression, b.scope);
  a.pop();
  this.value = b.value;
};
r.prototype.stepForInStatement = function (a, b, d) {
  if (
    !b.Lb &&
    ((b.Lb = !0), d.left.declarations && d.left.declarations[0].init)
  )
    return (
      b.scope.P &&
        J(
      ...
      new t(d.left, b.scope)
    );
  if (!b.va)
    return (b.va = !0), b.ha || (b.ha = b.value), new t(d.right, b.scope);
  b.U || ((b.U = !0), (b.u = b.value), (b.eb = Object.create(null)));
  if (void 0 === b.Ja)
    a: for (;;) {
      if (b.u instanceof C)
  ...
  if (!b.rb)
    ...
    else return (b.ha = null), (b = new t(a, b.scope)), (b.ma = !0), b;
  b.ha || (b.ha = b.value);
  ...
  b.rb = !1;
  b.oa = !1;
  if (d.body) return new t(d.body, b.scope);
};
r.prototype.stepForStatement = function (a, b, d) {
  var c = b.ga || 0;
  if (0 === c) {
    if (((b.ga = 1), d.init)) return new t(d.init, b.scope);
  } else if (1 === c) {
    if (((b.ga = 2), d.test)) return new t(d.test, b.scope);
  } else if (2 === c)
    if (((b.ga = 3), d.test && !b.value)) a.pop();
    else return (b.U = !0), new t(d.body, b.scope);
  else if (3 === c && ((b.ga = 1), d.update)) return new t(d.update, b.scope);
};
r.prototype.stepFunctionDeclaration = function (a) {
  a.pop();
};
r.prototype.stepFunctionExpression = function (a, b, d) {
  a.pop();
  b = a[a.length - 1];
  b.value = Dc(this, d, b.scope, b.Ia);
};
r.prototype.stepIdentifier = function (a, b, d) {
  a.pop();
...
r.prototype.stepLabeledStatement = function (a, b, d) {
  a.pop();
  a = b.labels || [];
  a.push(d.label.name);
  b = new t(d.body, b.scope);
  b.labels = a;
  return b;
};
r.prototype.stepLiteral = function (a, b, d) {
  a.pop();
  b = d.value;
  b instanceof RegExp && ((d = this.s(this.Fa)), Nc(this, d, b), (b = d));
  a[a.length - 1].value = b;
};
r.prototype.stepLogicalExpression = function (a, b, d) {
  ...
  else return (b.wa = !0), new t(d.right, b.scope);
};
r.prototype.stepMemberExpression = function (a, b, d) {
  if (!b.va) return (b.va = !0), new t(d.object, b.scope);
  if (d.computed)
    if (b.Mb) d = b.value;
    else return (b.u = b.value), (b.Mb = !0), new t(d.property, b.scope);
...
r.prototype.stepObjectExpression = function (a, b, d) {
  var c = b.A || 0,
    e = d.properties[c];
  if (b.u) {
    var g = b.Ia;
    b.Ca[g] || (b.Ca[g] = {});
    b.Ca[g][e.kind] = b.value;
    b.A = ++c;
    e = d.properties[c];
...
r.prototype.stepProgram = function (a, b, d) {
  if ((a = d.body.shift())) return (b.done = !1), new t(a, b.scope);
  b.done = !0;
};
r.prototype.stepReturnStatement = function (a, b, d) {
  if (d.argument && !b.S) return (b.S = !0), new t(d.argument, b.scope);
  nd(this, 3, b.value, void 0);
};
r.prototype.stepSequenceExpression = function (a, b, d) {
  var c = b.A || 0;
  if ((d = d.expressions[c])) return (b.A = c + 1), new t(d, b.scope);
  a.pop();
  a[a.length - 1].value = b.value;
};
r.prototype.stepSwitchStatement = function (a, b, d) {
  if (!b.ca) return (b.ca = 1), new t(d.discriminant, b.scope);
  1 === b.ca && ((b.ca = 2), (b.bc = b.value), (b.Wa = -1));
  for (;;) {
    var c = b.$a || 0,
      e = d.cases[c];
    if (b.Aa || !e || e.test)
      if (e || b.Aa || -1 === b.Wa)
        if (e) {
          if (!b.Aa && !b.yb && e.test)
            return (b.yb = !0), new t(e.test, b.scope);
          if (b.Aa || b.value === b.bc) {
            b.Aa = !0;
            var g = b.A || 0;
            if (e.consequent[g])
              return (
                (b.Tb = !0), (b.A = g + 1), new t(e.consequent[g], b.scope)
              );
          }
          b.yb = !1;
          b.A = 0;
...
r.prototype.stepThisExpression = function (a) {
  a.pop();
  a[a.length - 1].value = jd(this, "this");
};
r.prototype.stepThrowStatement = function (a, b, d) {
  if (b.S) J(this, b.value);
  else return (b.S = !0), new t(d.argument, b.scope);
};
r.prototype.stepTryStatement = function (a, b, d) {
  if (!b.Hb) return (b.Hb = !0), new t(d.block, b.scope);
  if (b.aa && 4 === b.aa.type && !b.Kb && d.handler)
    return (
      (b.Kb = !0),
      (a = new t(d.handler, b.scope)),
      (a.cc = b.aa.value),
      (b.aa = void 0),
      a
    );
  if (!b.Jb && d.finalizer) return (b.Jb = !0), new t(d.finalizer, b.scope);
  a.pop();
  b.aa && nd(this, b.aa.type, b.aa.value, b.aa.label);
};
r.prototype.stepUnaryExpression = function (a, b, d) {
  if (!b.S)
    return (
      (b.S = !0),
      (a = new t(d.argument, b.scope)),
  ...
  if ("-" === d.operator) c = -c;
    ...
    if (Array.isArray(c)) {
      ...
      try {
        ...
        b.scope.P
          ? J(this, this.m, "Cannot delete property '" + c + "' of '" + e + "'")
          : (d = !1);
      }
    }
    c = d;
...
r.prototype.stepUpdateExpression = function (a, b, d) {
  if (!b.ea)
    return (b.ea = !0), (a = new t(d.argument, b.scope)), (a.ma = !0), a;
  b.za || (b.za = b.value);
  b.ua && (b.fa = b.value);
  if (!b.ua) {
    var c = ld(this, b.za);
  ...
  if (b.oa) a.pop(), (a[a.length - 1].value = b.cb);
    ...
    d = d.prefix ? e : c;
    if ((c = md(this, b.za, e)))
      return (b.oa = !0), (b.cb = d), pd(this, c, b.za, e);
    a.pop();
    a[a.length - 1].value = d;
  }
};
r.prototype.stepVariableDeclaration = function (a, b, d) {
  d = d.declarations;
  var c = b.A || 0,
    e = d[c];
  b.vb && e && (kd(this, e.id.name, b.value), (b.vb = !1), (e = d[++c]));
  for (; e; ) {
    if (e.init)
      return (b.A = c), (b.vb = !0), (b.Ia = e.id.name), new t(e.init, b.scope);
    e = d[++c];
  }
  a.pop();
};
r.prototype.stepWithStatement = function (a, b, d) {
  if (b.va)
    if (b.Ib) a.pop();
    else return (b.Ib = !0), (a = id(this, b.scope, b.value)), new t(d.body, a);
  else return (b.va = !0), new t(d.object, b.scope);
};
r.prototype.stepWhileStatement = r.prototype.stepDoWhileStatement;
this.Interpreter = r;
r.prototype.step = r.prototype.fb;
r.prototype.run = r.prototype.xb;
r.prototype.appendCode = r.prototype.Bb;
r.prototype.createObject = r.prototype.ta;
r.prototype.createObjectProto = r.prototype.s;
r.prototype.createAsyncFunction = r.prototype.ob;
r.prototype.createNativeFunction = r.prototype.i;
r.prototype.getProperty = r.prototype.D;
r.prototype.setProperty = r.prototype.g;
r.prototype.nativeToPseudo = r.prototype.Ba;
r.prototype.pseudoToNative = r.prototype.O;
r.prototype.getGlobalScope = r.prototype.Qb;
r.prototype.getStateStack = r.prototype.Rb;
r.prototype.setStateStack = r.prototype.$b;
